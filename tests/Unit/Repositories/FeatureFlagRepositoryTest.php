...
it('can get all feature flags', function (): void {
    ...
    expect($model->features()->all()->sortBy('id')->first()->is_active)->toBe($featureFlag->is_active);
    ...
    expect($model->features()->all()->sortByDesc('id')->first()->is_active)->toBe($featureFlag2->is_active);
});
...
it('can activate a feature flag', function (): void {
    ...
    expect($model->featureFlags()->first()->is_active)->toBe($featureFlag->is_active);
});
...
it('can activate multiple feature flags', function (): void {
    ...
    expect($model->featureFlags()->orderBy('id')->first()->is_active)->toBe($featureFlag->is_active);
    ...
    expect($model->featureFlags()->orderByDesc('id')->first()->is_active)->toBe($featureFlag2->is_active);
});
